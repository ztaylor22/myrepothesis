...
```{r}
#NEW TIMETK VISUALIZATIONS
#.interactive=FALSE makes it a static visualization based on ggplot library
master_df %>%
...
master_df %>%
  group_by(Index) %>%
  plot_time_series(Date, Close, .facet_scales="free", .smooth=FALSE, .color_var=month(date), .interactive=FALSE)
