...
master_df$AfterEvent1 = ifelse(master_df$Date >= as.Date('2022-07-27'), 1, 0)
#same but for event 2: Sinema
master_df$AfterEvent2 = ifelse(master_df$Date >= as.Date('2022-08-04'), 1, 0)
#same but for event 3: law signed
master_df$AfterEvent3 = ifelse(master_df$Date >= as.Date('2022-08-16'), 1, 0)

#Creating an interaction term between AfterEvent1 and Group
master_df$Interaction1 = master_df$AfterEvent1 * master_df$Group
...
master_df$Event1 = ifelse(master_df$Date == as.Date('2022-07-27'), 1, 0)
master_df$P02 = ifelse(master_df$Date == as.Date('2022-07-28'), 1, 0)
...
master_df$Event2 = ifelse(master_df$Date == as.Date('2022-08-04'), 1, 0)
...
master_df$PEvent3 = ifelse(master_df$Date == as.Date('2022-08-12'), 1, 0)
...
```{r}
#Diff-in-Diff Regressor
didreg1 = lm(Returns ~ AfterEvent1 + Group + Interaction1, data = master_df) 
