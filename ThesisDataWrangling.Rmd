...
p + annotate("text", x=as.Date("2022-07-27"), y=0.06, label="Announcement", color="blue", size=7, fontface="bold", angle=15) + annotate("text", x=as.Date("2022-08-04"), y=0.06, label="Dems Unified", color="black", size=7, fontface="bold", angle=15) + annotate("text", x=as.Date("2022-08-16"), y=0.06, label="Bill Signed", color="black", size=7, fontface="bold", angle=15)
```


```{r}
#This is not fully updated with all the interaction terms
...
```{r}
#EVERYTHING BEYOND THIS IS OLD CODE AND CAN BE IGNORED
