...
#master_df1$Group = ifelse(master_df$Group == 1, "1", "0")

ggplot(master_df1, aes(x=Date, y=Returns, group=Group, color=Group)) + geom_line() + labs(x="Date", y="Stock Returns") + ggtitle("Stock Returns For Qualified and Unqualified Groups")
